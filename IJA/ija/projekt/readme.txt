...
For compiling the application and generating documentation run...

```
user@machine:/path/to/project$ ant compile
```

For remove of all built files and documentation run...
```
user@machine:/path/to/project$ ant clean
```
...
```
user@machine:/path/to/project$ ant run
```
